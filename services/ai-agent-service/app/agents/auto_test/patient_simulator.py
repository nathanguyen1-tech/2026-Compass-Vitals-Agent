...
async def get_patient_response(
    ...
    system_prompt = PATIENT_SIMULATOR_PROMPT.format(
        ...
        gender=scenario.gender or "không rõ",
        age=scenario.age or "không rõ",
        medical_history=scenario.medical_history or scenario.patient_history or "không có tiền sử đặc biệt",
        current_medications=scenario.current_medications or "không có",
        allergies=scenario.allergies or "không có",
